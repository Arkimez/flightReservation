...
public class airline {
    ...
    System.out.printf("Price (RM)    :RM %.2f%n",flightPrice);
    ...
    System.out.printf("\nTotal Price :RM %.2f%n",totalPrice);
    ...
    public static void checkSchedule() {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (parts[0].equals(String.valueOf(userID))) {
                ...
                System.out.println("Flight Number : " + parts[2]);
                System.out.println("Origin        : " + parts[3]);
                System.out.println("Destination   : " + parts[4]);
                System.out.println("Date          : " + parts[5]);
                System.out.println("Seats         : " + parts[6]);
                System.out.println("Total Price   : RM " + parts[7]);
                System.out.println("=====================================\n");
                found = true;
            }
        }
